...
/* Private defines -----------------------------------------------------------*/
#define VCSP_L_Pin GPIO_PIN_0
#define VCSP_L_GPIO_Port GPIOA
#define VCSN_L_Pin GPIO_PIN_1
#define VCSN_L_GPIO_Port GPIOA
#define VBUS_ADC_Pin GPIO_PIN_4
#define VBUS_ADC_GPIO_Port GPIOA
#define BOARD_ID_0_Pin GPIO_PIN_5
